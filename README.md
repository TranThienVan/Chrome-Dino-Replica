Hello, this is the Running Dino CLONE game which takes the inspiration from a famous Running Dino Chrome Game when user lost their connection to the Internet. 
